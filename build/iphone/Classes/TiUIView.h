...
/**
 Base class for all FinalProject views.
 @see TiViewProxy
 */
...
/**
 Whether or not a view not normally picked up by the FinalProject view hierarchy (such as wrapped iOS UIViews) was touched.

...
//@interface FinalProjectObject : NSObject
//@end

@interface FinalProjectObject (Private)
...
void KrollPropertyNames(TiContextRef ctx, TiObjectRef object, TiPropertyNameAccumulatorRef propertyNames)
{
	...
	if (o)
	{
		...
		if ([o isKindOfClass:[FinalProjectObject class]])
		{
			for (NSString *key in [[(FinalProjectObject*)o modules] allKeys])
			{

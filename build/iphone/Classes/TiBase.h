...
// in simulator we redefine to format for FinalProject Developer console
...
{\
	NSString * exceptionName = [@"org.finalproject." stringByAppendingString:NSStringFromClass([self class])];\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
\
+ (void) throwException:(NSString *) reason subreason:(NSString*)subreason location:(NSString *)location\
{\
	NSString * exceptionName = @"org.finalproject";\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
...
enum {
	UIFinalProjectNativeItemNone = -1, 
	UIFinalProjectNativeItemSpinner = -2,
	UIFinalProjectNativeItemProgressBar = -3,
	
	UIFinalProjectNativeItemSlider = -4,
	UIFinalProjectNativeItemSwitch = -5,
	UIFinalProjectNativeItemMultiButton = -6,
	UIFinalProjectNativeItemSegmented = -7,
	
	UIFinalProjectNativeItemTextView = -8,
	UIFinalProjectNativeItemTextField = -9,
	UIFinalProjectNativeItemSearchBar = -10,
	
	UIFinalProjectNativeItemPicker = -11,
	UIFinalProjectNativeItemDatePicker = -12,
	
	UIFinalProjectNativeItemInfoLight = -13,
	UIFinalProjectNativeItemInfoDark = -14,
	
	UIFinalProjectNativeItemDisclosure = -15,
	
	UIFinalProjectNativeItemContactAdd = -16
};
...
/**
 *	TiThreadPerformOnMainThread should replace all FinalProject instances of

...
@interface FinalProjectObject : KrollCoverageObject {
#else
@interface FinalProjectObject : KrollObject {
#endif
@private
...
extern NSString * FinalProject$ModuleRequireFormat;
...
@private
	...
	NSMutableDictionary *modules;
	FinalProjectObject *_finalproject;
    KrollObject* console;
	BOOL shutdown;

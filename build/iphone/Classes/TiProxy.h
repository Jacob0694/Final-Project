...
//Rare exceptions to indicate a bug in the _finalproject code (Eg, function that a subclass should have implemented)
...
/**
 The base class for FinalProject proxies.
 */
